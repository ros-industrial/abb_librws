...
The following is a conceptual sketch of how this RWS library can be viewed, in relation to an ABB robot controller as well as the EGM companion library mentioned above. The optional *StateMachine Add-In* is related to the robot controller's RAPID program and system configurations.
...
This library is generic and can be used together with any RAPID program and system configurations. The library's primary classes are:
...
The optional *StateMachine Add-In* can be used in combination with any of the classes above, but it works especially well with the *RWSStateMachineInterface* class.
